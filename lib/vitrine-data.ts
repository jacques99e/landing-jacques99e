...
export const APP_MODULES: AppModule[] = [
  {
    ...
    features: [
      "Caisse avec espèces & Mobile Money",
      "Catalogue partageable sur WhatsApp",
      "Boutique publique /boutique/votre-slug",
      "Alertes stock bas & exports PDF",
    ],
    color: "bg-[#075E54]",
  },
  {
    ...
    features: [
      "Carnet cultures & intrants",
      "Prix marchés locaux éditables",
      "Calcul rendement & revenus estimés",
  ...
  },
  {
    ...
    features: [
      "Création colis + code suivi",
      "Portail public /suivi pour clients",
      "SMS destinataire à l'expédition",
  ...
  },
  {
    ...
    features: [
      "Portail public /formation",
      "Vidéos, quiz & sous-titres",
      "Certificat PDF avec QR vérifiable",
      "Invitation élèves par SMS",
    ],
    color: "bg-amber-600",
  },
  {
    ...
    features: [
      "Enregistrement actifs & lots",
      "Portail public /trace",
      "Contrats numériques coopératives",
      "Grand livre vérifiable",
    ],
    color: "bg-indigo-600",
  },
];
